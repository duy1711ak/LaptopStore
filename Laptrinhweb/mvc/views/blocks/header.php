...
<head>
    ...
    <body>
            <!-- Begin Header -->
            <nav id="navColor" class=" navbar fixed-top navbar-expand-lg navbar-light bg-light" style="position:sticky;position:-webkit-sticky">
                <a class="navbar-brand" href="http://localhost/Laptrinhweb/Home"><img src="http://localhost/Laptrinhweb/public/BKU.png"></a>
