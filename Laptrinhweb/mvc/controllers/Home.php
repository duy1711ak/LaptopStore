...
class Home extends Controller{
    ...
    function SayHi() {
        $productAsus = $this->productModel->selectProductCategory(1,1);
        $productDell = $this->productModel->selectProductCategory(2,1);
        $productHP = $this->productModel->selectProductCategory(3,1);
        $productLenovo = $this->productModel->selectProductCategory(102,1);
        $productMacbook = $this->productModel->selectProductCategory(104,1);
        $this->view("home",[
            "render"=>"home",
            "allCategory"=>$this->allCategory,
            "productAsus"=>$productAsus,
            "productDell"=>$productDell,
            "productHP"=>$productHP,
            "productLenovo"=>$productLenovo,
            "productMacbook"=>$productMacbook
        ]);   
    }
